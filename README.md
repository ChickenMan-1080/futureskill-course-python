...
## ภาพรวมการทำงาน
 ...
 - เมื่อรัน script จะมีหน้า GUI ถามความพร้อมของผู้ใช้ ซึ่งมีให้ตอบ 2
 ...
 - เมื่อตอบ **y** ระบบจะถามความกว้างและความยาวของสี่เหลี่ยมผืนผ้าให้ผู้ใช้ใส่ **input**
 - ในกรณีที่ผู้ใช้ใส่ **ความกว้าง == 6** และ **ความยาว == 7**  ระบบจะขึ้นหน้าต่างพร้อมข้อความ **67** ทั่วหน้าต่าง GUI (ใส่มาเพื่อให้มีลูกเล่น) แล้วจบการทำงาน แต่หาก เป็นตัวเลขนอกเหนือจากนั้นระบบจะแสดงผลคูณของ ความกว้าง และ ความยาว แล้วถามจะถามผู้ใช้ว่าอยากเล่นต่อไหม โดยให้ตอบ y หรือ n
 - หากตอบนอกเหนือจาก **y** และ **n** จะวน Loop ถามซ้ำไปเรื่อยๆ และเมื่อตอบ **"y"** ระบบจะออกจาก Loop แล้วกลับไปเล่นใหม่ แต่หากตอบ **"n"** ก็จะจบการทำงานโปรแกรม
